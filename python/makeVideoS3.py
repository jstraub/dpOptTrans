...
#  src = mlab.pipeline.scalar_scatter(xs, ys, zs, mode="sphere")
  ...
  mlab.view(azimuth=2.*n/float(len(qs))*360,
      elevation=90.,distance=22., focalpoint=np.array([ 0.27005684,
        0.0733304 ,  0.54855263]))
  print mlab.view()
  ...
  mlab.axes(extent=ranges, ranges=ranges)
  mlab.view(azimuth=(2.*n+1)/float(len(qs))*360,
      elevation=90.,distance=22., focalpoint=np.array([ 0.27005684,
        0.0733304 ,  0.54855263]))
